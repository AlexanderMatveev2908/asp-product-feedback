...
import { BtnVotesResponsive } from '@/common/components/btns/btn_votes/btn_votes_responsive/btn-votes-responsive';

@Component({
  selector: 'app-card-version-row',
  imports: [UseTabletDir, CategorySpan, CommentsCount, BtnVotesResponsive],
