...
import { FeedbackFormPostT } from '@/features/feedbacks/etc/forms/feedback_form/etc/form_mng';
...
export class ProductsPost {
  ...
  public readonly postStrategy: (data: FeedbackFormPostT) => Observable<unknown> = (
    data: FeedbackFormPostT
  ) =>
